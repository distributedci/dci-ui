...
function HardwareSection({ hardware }: { hardware: IHardwareData }) {
  ...
  // Extract disks - look for id === "disk"
  const disks = findInTree(children, (item: any) => item.id === "disk");
            ...
            <Table>
              ...
              <Tbody>
                {disks.map((disk: any, index: number) => (
                  <Tr key={index}>
                    <Td>{disk.logicalname || disk.dev || "N/A"}</Td>
            ...
            <Table>
              ...
              <Tbody>
                {networkCards.map((card: any, index: number) => {
                  const linkStatus = card.configuration?.link === "yes" ? "Up" : card.configuration?.link === "no" ? "Down" : card.configuration?.link || "N/A";
                  ...
                  return (
                    <Tr key={index}>
                      ...
                      <Td>{product}</Td>
                      <Td>{card.logicalname || card.id || "N/A"}</Td>
