      ...
      >
        <Content>
          ...
          <Content component={ContentVariants.p}>
            ...
            <span className="pf-v6-u-background-color-200 pf-v6-u-px-xs pf-v6-u-mx-xs">
              job-name
            </span>
          </Content>
          ...
          <Content component={ContentVariants.p}>
            ...
            and status
            <span className="pf-v6-u-background-color-success pf-v6-u-px-xs pf-v6-u-mx-xs">
              success
            </span>
          </Content>
          ...
          <Content component={ContentVariants.p}>
            ...
            and status
            <span className="pf-v6-u-background-color-danger pf-v6-u-px-xs pf-v6-u-mx-xs">
              failure
            </span>
            or
            <span className="pf-v6-u-background-color-danger pf-v6-u-px-xs pf-v6-u-mx-xs">
