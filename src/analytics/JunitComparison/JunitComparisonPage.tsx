...
export default function JunitComparisonPage() {
  ...
  const [topicId1, setTopicId1] = useState<string | null>(params.topic_id1);
  const [topicId2, setTopicId2] = useState<string | null>(params.topic_id2);
      ...
      <Card>
        <CardBody>
          ...
          >
            <ToolbarContent>
              <ToolbarGroup>
                <ToolbarItem>Compare topic</ToolbarItem>
              </ToolbarGroup>
              <ToolbarGroup>
                <ToolbarItem>
                  <TopicsFilter
                ...
                <ToolbarItem>
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setIsLoading(true);
                      http
                        .get("/api/v1/analytics/junit_comparison")
                        .then((response) => {
                    ...
                    isDisabled={topicId1 === null || topicId2 === null}
                  >
                    Compare
                  </Button>
                </ToolbarItem>
