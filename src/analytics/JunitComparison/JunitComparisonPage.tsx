...
interface IJunitComparisonFilters {
...
export function createJunitComparisonSearchFromFilters(
  filters: IJunitComparisonFilters
) {
  return qs.stringify(
    {
      ...filters,
...
export default function JunitComparisonPage() {
  ...
  //const params = parseJunitComparisonFiltersFromSearch(location.search);
  const initialValues = {
    topic_1_id: null,
    ...
    tags_2: [],
    test_name: null,
  } as JunitComparisonForm;
  const [values, setValues] = useState<JunitComparisonForm>({
    ...initialValues,
  });
  ...
  function setPartialValues<T extends keyof JunitComparisonForm>(
    newValues: Record<T, JunitComparisonForm[T]>
  ) {
    setValues({
      ...values,
      ...newValues,
                ...
                <ToolbarItem>
                  <TopicsFilter
                    ...
                    onSelect={(topic) =>
                      setPartialValues({
                        topic_1_id: topic.id,
                        topic_1_start_date: topic.created_at,
                        topic_1_end_date: DateTime.now()
                          .toUTC()
                ...
                <ToolbarItem>
                  <TopicsFilter
                    ...
                    onSelect={(topic) =>
                      setPartialValues({
                        topic_2_id: topic.id,
                        topic_2_start_date: topic.created_at,
                        topic_2_end_date: DateTime.now()
                          .toUTC()
                          .toISO({ includeOffset: false }),
                      })
                    }
