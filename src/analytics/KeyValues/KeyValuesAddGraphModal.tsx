...
import { CheckCircleIcon, PlusIcon } from "@patternfly/react-icons";
import { IGraphKeyValues } from "types";
import {
...
export default function KeyValuesAddGraphModal({
  ...
  const { control, handleSubmit, setValue, watch } = useForm<IKeyValueGraph>({
    defaultValues: {
      keys: [{ key: Object.keys(keyValues)[0], color: keyValueGraphColors[0] }],
