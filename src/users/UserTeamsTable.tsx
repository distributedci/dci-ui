...
import { useListUserTeamsQuery, useRemoveUserFromTeamMutation, useAddUserToTeamMutation } from "./usersApi";
...
export function UserTeamsTable({ user }: { user: IUser; }) {
  ...
  const [addUserToTeam, { isLoading: isLoadingAddUserToTeam }] = useAddUserToTeamMutation();
